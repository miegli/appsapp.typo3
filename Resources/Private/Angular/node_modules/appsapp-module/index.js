...
var AppsappInputComponent = (function (_super) {
    ...
    AppsappInputComponent.prototype.ngOnInit = function () {
        ...
        if (this.model) {
            if (this.property) {
                this._inputs.push({ type: this.model.getType(this.property), property: this.property, label: this.label, hidden: new Observable$1(function (observer) {
                ...
                Object.keys(this.model).forEach(function (property) {
                    if (property.substr(0, 1) !== "_") {
                        _this._inputs.push({
                            type: _this.model.getType(property), property: property, hidden: new Observable$1(function (observer) {
...
var AppsappInputNumberPlainComponent = (function (_super) {
    __extends$18(AppsappInputNumberPlainComponent, _super);
