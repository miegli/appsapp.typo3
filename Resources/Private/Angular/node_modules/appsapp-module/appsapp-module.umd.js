(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('rxjs/Observable'), require('rxjs/add/operator/map'), require('appsapp-cli'), require('angularfire2/database'), require('angularfire2/auth'), require('firebase'), require('angular-2-local-storage'), require('object-hash'), require('@mobiscroll/angular'), require('@angular/common/http'), require('@angular/forms')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'rxjs/Observable', 'rxjs/add/operator/map', 'appsapp-cli', 'angularfire2/database', 'angularfire2/auth', 'firebase', 'angular-2-local-storage', 'object-hash', '@mobiscroll/angular', '@angular/common/http', '@angular/forms'], factory) :
	(factory((global['appsapp-module'] = {}),global.core,global.common,global.Observable,null,global.appsappCli,global.database,global.auth,global.firebase,global.angular2LocalStorage,global.objectHash,global.angular,global.http,global.forms));
}(this, (function (exports,core,common,Observable,map,appsappCli,database,auth,firebase,angular2LocalStorage,objectHash,angular,http,forms) { 'use strict';
...
var AppsappInputComponent = (function (_super) {
    ...
    AppsappInputComponent.prototype.ngOnInit = function () {
        ...
        if (this.model) {
            if (this.property) {
                this._inputs.push({ type: this.model.getType(this.property), property: this.property, label: this.label, hidden: new Observable.Observable(function (observer) {
                ...
                Object.keys(this.model).forEach(function (property) {
                    if (property.substr(0, 1) !== "_") {
                        _this._inputs.push({
                            type: _this.model.getType(property), property: property, hidden: new Observable.Observable(function (observer) {
